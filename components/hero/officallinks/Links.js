...
const Links = () => {
  return (
    <div className={style.link_box}>
      <h3 className={style.heading}>Official Links</h3>
      <div className={style.links_container}>
        <Link href="#" className={style.link}>
          <button className={`${style.btn} ${style.active}`}>
            Official Website
            <span className={style.span_link}>www.mozilla.org/firefox</span>
          </button>
        </Link>
        <Link href="#" className={style.link}>
        ...
        <Link href="#" className={style.link}>
          <button className={style.btn}>
            <span className={style.span_icon}>
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
                ...
                className="text-[#333] h-auto w-[18px] mr-[6px]"
              >
